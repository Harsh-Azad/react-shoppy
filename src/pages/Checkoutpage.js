...
function Checkout() {
    return ( 
        ...
        <form className="bg-white px-5 py-5 mt-12">
          ...
          <h2 className="text-4xl my-4 font-semibold leading-7 text-gray-900">Personal Information</h2>
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          Choose from one of your existing addresses.
          </p>
              ...
              <div className="mt-6 space-y-6">
                ...
                <div className="flex items-center gap-x-3">
                  <input
                    ...
                    className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"
                  />
                  <label htmlFor="scan" className="block text-sm font-medium leading-6 text-gray-900">
                    UPI(scan QR)
                  </label>
                </div>
              </div>
